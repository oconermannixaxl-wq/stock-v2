<aside class="main-sidebar">
  ...
  <li class="treeview" id="mainDeliveryNav">
    <a href="#">
    ...
    <ul class="treeview-menu">
      <?php if(in_array('viewDelivery', $user_permission)): ?>
        <li id="trackDeliveryNav">
          <a href="<?php echo base_url('delivery/track') ?>">
            <i class="fa fa-circle-o"></i> Track Delivery
          </a>
        </li>
      <?php endif; ?>

      <?php if(in_array('updateDelivery', $user_permission)): ?>
        <li id="editDeliveryNav">
          <a href="<?php echo base_url('delivery/edit') ?>">
            <i class="fa fa-circle-o"></i> Edit Delivery
          </a>
        </li>
      <?php endif; ?>
    </ul>
  ...
  <li class="treeview" id="mainPaymentNav">
    ...
    <ul class="treeview-menu">
      ...
      <?php if(in_array('updatePayment', $user_permission) || in_array('viewPayment', $user_permission) || in_array('deletePayment', $user_permission)): ?>
        <li id="managePaymentNav">
          <a href="<?php echo base_url('payment') ?>">
            <i class="fa fa-circle-o"></i> Manage Payment
          </a>
        </li>
      <?php endif; ?>
    </ul>
