  ...
  <td>Delivery</td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="createDelivery" 
    <?php if($serialize_permission) { if(in_array('createDelivery', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="updateDelivery" 
    <?php if($serialize_permission) { if(in_array('updateDelivery', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="viewDelivery" 
    <?php if($serialize_permission) { if(in_array('viewDelivery', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="deleteDelivery" 
    <?php if($serialize_permission) { if(in_array('deleteDelivery', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
</tr>
  ...
  <td>Payments</td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="createPayment" 
    <?php if($serialize_permission) { if(in_array('createPayment', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="updatePayment" 
    <?php if($serialize_permission) { if(in_array('updatePayment', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="viewPayment" 
    <?php if($serialize_permission) { if(in_array('viewPayment', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
  <td>
    <input type="checkbox" name="permission[]" class="minimal" value="deletePayment" 
    <?php if($serialize_permission) { if(in_array('deletePayment', $serialize_permission)) { echo "checked"; } } ?>>
  </td>
</tr>
